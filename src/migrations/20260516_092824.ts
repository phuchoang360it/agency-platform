...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "tenants" ADD CONSTRAINT "tenants_media_folder_id_media_folders_id_fk" FOREIGN KEY ("media_folder_id") REFERENCES "public"."media_folders"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "media_folders" ADD CONSTRAINT "media_folders_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "tenants_media_folder_idx" ON "tenants" USING btree ("media_folder_id");
  ...
  CREATE INDEX "media_folders_tenant_idx" ON "media_folders" USING btree ("tenant_id");
